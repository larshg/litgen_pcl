...
void py_init_module_pcl(nb::module_& m)
{
    ...
    ////////////////////    <generated_from:pcl.h>    ////////////////////
    m.def("add",
        nb::overload_cast<int, int>(pcl::add),
        nb::arg("a"), nb::arg("b"),
        "Simple add function (this will be the docstring)");

    m.def("add",
        nb::overload_cast<int, int, int>(pcl::add),
    ...
    auto pyClassPoint =
        ...
        .def("__init__", []( pcl::Point *self,
        int x = 0, int y = 0)
        {
            new (self) pcl::Point();  // placement new
            auto r = self;
            r->x = x;
            r->y = y;
        },
        ...
        .def_rw("x", &pcl::Point::x, "")
        .def_rw("y", &pcl::Point::y, "")
        ;


    auto pyClassWidget =
        nb::class_<pcl::Widget>
            (m, "Widget", "A class will publish only its public methods and members")
        .def(nb::init<>())
        .def("get_value",
            &pcl::Widget::get_value)
        .def("set_value",
            &pcl::Widget::set_value, nb::arg("v"))
        ;
    ...
    auto pyClassAnimal =
        nb::class_<pcl::Animal, pcl::Animal_trampoline>
    ...
    m.def("min_value",
        nb::overload_cast<const std::vector<int> &>(pcl::MinValue<int>),
        nb::arg("values"),
    ...
    m.def("min_value",
        nb::overload_cast<const std::vector<float> &>(pcl::MinValue<float>),
        nb::arg("values"),
        " MinValue will be published as min_value for both int and float\n See inside tools/autogenerate_bindings.py:\n    options.fn_template_options.add_specialization(\"^MinValue$\", [\"int\", \"float\"], add_suffix_to_function_name=False)");

    m.def("get_widget_singleton",
        pcl::GetWidgetSingleton,
    ...
    m.def("switch_bool_value",
        [](BoxedBool & v)
        {
            auto SwitchBoolValue_adapt_modifiable_immutable = [](BoxedBool & v)
            {
                ...
                pcl::SwitchBoolValue(v_boxed_value);
            };
